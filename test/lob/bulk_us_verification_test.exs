defmodule Lob.BulkUSVerificationTest do
  use ExUnit.Case

  alias Lob.BulkUSVerification
  ...
  describe "verify/2" do
    ...
    test "verifies a US address", %{sample_address: sample_address} do
      {:ok, %{addresses: [verified_address]}, _headers} = BulkUSVerification.verify(%{addresses: [sample_address]})
